...
class OrderCrudController extends AbstractCrudController
{
    ...
    public function updatePreparation(AdminContext $context)
    {
        ...
        $test = $this->addFlash('notice', "<span style='color: green'>La commande ".$order->getReference()." est bien en cours de préparation</span>");
    ...
    public function updateDelivery(AdminContext $context)
    {
        ...
        $test = $this->addFlash('notice', "<span style='color: #6161fa'>La commande " .$order->getReference()." est bien en cours de livraison</span>");
